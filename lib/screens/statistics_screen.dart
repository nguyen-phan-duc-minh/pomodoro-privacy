                ...
                Row(
                  children: [
                    Expanded(
                      child: _buildCard(
                        'Thời gian học',
                        '${todayStats.totalStudyMinutes} phút',
                        Icons.timer,
                        Colors.blue,
                      ),
                    ),
                    ...
                    Expanded(
                      child: _buildCard(
                        'Pomodoro',
                        '${todayStats.completedCycles} vòng',
                        Icons.check_circle,
                        Colors.green,
                      ),
                    ),
                ...
                Row(
                  children: [
                    Expanded(
                      child: _buildCard(
                        'Tổng thời gian',
                        '${stats.getTotalStudyMinutes()} phút',
                        Icons.schedule,
                        Colors.orange,
                      ),
                    ),
                    ...
                    Expanded(
                      child: _buildCard(
                        'Tổng Pomodoro',
                        '${stats.getTotalCompletedCycles()} vòng',
                        Icons.repeat,
                        Colors.purple,
                      ),
                    ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${stat.totalStudyMinutes} phút • ${stat.completedCycles} vòng',
